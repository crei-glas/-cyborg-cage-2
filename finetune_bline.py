...
if __name__ == '__main__':
    ...
    # Define only the bline model to train
    models_config = [
        {
            'name': 'bline',
            'red_agent': B_lineAgent,
            'bc_model_path': "Models/bc_bline_fixed/bline/model.pth"  # Use the best model from BC
        }
    ]

    # Use a unique approach name for the warm-started models
    warm_start_approach = "warm_start_bline_only"
