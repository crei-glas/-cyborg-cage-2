    ...
    def __init__(self, data_dir):
        ...
        for file_path in tqdm(trajectory_files, desc="Loading trajectories"):
            try:
                ...
                # RE-ENABLE FILTERING: Skip trajectory if it's not meander
                if blue_agent_type and blue_agent_type != 'meander':
                    trajectories_skipped += 1
                    if trajectories_skipped < 10:  # Limit the logging
                        print(f"Skipping trajectory with blue agent type: {blue_agent_type}")
                    continue
...
if __name__ == '__main__':
    ...
    # Define models to train - ONLY Meander Agent
    models_config = [
        {
            'name': 'meander',
            'data_dir': "Data/meander_only/RedMeanderAgent_30steps"
        }
    ]
    ...
    # Train Meander model using behavior cloning
