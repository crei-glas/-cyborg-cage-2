...
RED_AGENTS = [B_lineAgent]  # Only use B_lineAgent

# Create Data directory if it doesn't exist
DATA_DIR = "Data/bline_only"
...
def debug_get_action(self, observation, action_space=None):
    ...
    if len(self.start_actions) == 0 and not self.agent_loaded and not self.fingerprint_logged:
        ...
        # Force agent to be bline only - override any fingerprinting
        if not self.agent_loaded:
            # Skip the fingerprinting check and always load bline
